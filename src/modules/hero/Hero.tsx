...
export const Hero = () => {
  ...
  return (
    <>
      ...
      />
      <rect
        width={store.map.tileSize / 2}
        height={store.map.tileSize / 2}
        x={store.player.hero.location.x + store.map.tileSize / 4}
        y={store.player.hero.location.y + store.map.tileSize / 4}
        fill={"white"}
        stroke="black"
      />
    </>
